		...
		<Section>
			...
			<Container fixed maxWidth="md">
				...
				<Typography gutterBottom component="em">
					Effective date: December 03, 2019
				</Typography>

				<Typography gutterBottom>
					Auburn Pulsars (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;)
					operates the http://auburnpulsars.com website (hereinafter referred to
					as the &quot;Service&quot;).
				</Typography>
				...
				<Typography gutterBottom>
					...
					Auburn Pulsars is created with the help of the{" "}
				...
				<Typography gutterBottom>
					...
					such as your computer&aposs Internet Protocol address (e.g. IP
				...
				<Typography gutterBottom>
					Auburn Pulsars uses the collected data for various purposes:
				</Typography>
				<ul>
				...
				<Typography gutterBottom>
					Auburn Pulsars will take all steps reasonably necessary to ensure that
				...
				<Typography gutterBottom>
					Auburn Pulsars may disclose your Personal Data in the good faith
					belief that such action is necessary to:
				</Typography>
				<ul>
					<li>To comply with a legal obligation</li>
					<li>
						To protect and defend the rights or property of Auburn Pulsars
					</li>
					<li>
				...
				<ul>
					<li>By email: eric.stermer@gmail.com</li>
				</ul>
			</Container>
		</Section>
	)
